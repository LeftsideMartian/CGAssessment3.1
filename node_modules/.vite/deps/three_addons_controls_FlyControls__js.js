import { ga as Quaternion, vt as Controls, zs as Vector3 } from "./three.module-BLr34Qqw.js";
//#region node_modules/three/examples/jsm/controls/FlyControls.js
/**
...
function onPointerDown(event) {
	if (this.enabled === false) return;
	if (this.dragToLook) this._status++;
	else {
		switch (event.button) {
			case 0:
				this._moveState.forward = 1;
